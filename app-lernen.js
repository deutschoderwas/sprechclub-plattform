...
(function () {
  ...
  function amandaStil() {
    ...
    st.textContent = [
      ...
      '  font-size:13.5px;font-weight:700;color:var(--rot,var(--akt,#E1352C));padding:12px;min-height:46px;cursor:pointer}',
  ...
  function appStil() {
    ...
    s.textContent = [
      ...
      '  font:inherit;font-weight:700;font-size:14px;color:var(--rot,var(--akt,#E1352C));cursor:pointer;}',
