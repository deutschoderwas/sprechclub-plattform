...
(function () {
  ...
  function amandaStil() {
    ...
    st.textContent = [
      ...
      '.am-buehne{background:linear-gradient(180deg,var(--gelb-hauch,#F6F9FA) 0%,var(--creme,#F6F9FA) 62%,var(--bg) 100%)!important}',
      '.am-buehne .kopf-zeile .zur{border-color:var(--linie,#E7ECEE)!important;color:var(--tinte,#14181B)!important}',
      '.am-name{color:var(--tinte,#14181B)!important}',
      '.am-zustand{color:var(--petrol,var(--tq,#10627A))!important}',
      ...
      '.amt-u{font-size:13.5px;line-height:1.5;color:var(--ink2,#5A6B72);margin:0 0 12px}',
      ...
      '  background:var(--karte,var(--card,#FFFFFF));border:2px solid var(--tinte,var(--ink,#14181B));',
      ...
      '.amt-t.an{border-color:var(--petrol,var(--tq,#10627A))}',
      ...
      '.amt-b .bild{flex:none;width:52px;height:44px;border-radius:10px;overflow:hidden;background:var(--creme,#F6F9FA)}',
      ...
      '  font-size:13.5px;font-weight:700;color:var(--rot,var(--akt,#D42A21));padding:12px;min-height:46px;cursor:pointer}',
      '.amt-zurueck{background:none;border:0;font:inherit;font-size:13.5px;font-weight:700;',
      '  color:var(--ink2,#5A6B72);padding:8px 0;min-height:44px;cursor:pointer}'
    ].join('');
  ...
  function appStil() {
    ...
    s.textContent = [
      ...
      '.al-am{display:flex;align-items:flex-end;gap:12px;background:var(--creme,var(--bg,#F6F9FA));',
      ...
      '.al-am .tx{padding-bottom:12px;font-size:14px;line-height:1.5;color:var(--ink2,#5A6B72);}',
      '.al-am .ruf{display:block;font-family:var(--schrift-notiz,\'Caveat\',cursive);font-size:20px;',
      '  font-weight:600;line-height:1.1;margin-bottom:2px;color:var(--petrol,var(--tq,#10627A));}',
      '.al-am b{color:var(--ink,#14181B);}',
      '.al-am .frag{display:inline-block;margin-top:7px;background:none;border:0;padding:0;',
      '  font:inherit;font-weight:700;font-size:14px;color:var(--rot,var(--akt,#D42A21));cursor:pointer;}',
      ...
      '  background:var(--card,#fff);border:1px solid var(--line,#F6F9FA);border-radius:16px;',
      '  padding:9px 12px 9px 9px;font:inherit;}',
      '.ls-app-z:active{transform:scale(.985);}',
      '.ls-app-z img{width:56px;height:56px;border-radius:12px;object-fit:cover;flex:none;background:var(--line,#F6F9FA);}',
      '.ls-app-z .pl{width:56px;height:56px;border-radius:12px;background:var(--line,#F6F9FA);flex:none;}',
      '.ls-app-z .em{width:44px;height:44px;border-radius:12px;background:var(--line,#F6F9FA);flex:none;',
      ...
      '.ls-app-z .pf{color:var(--ink3,var(--mute,#C7D0D4));font-size:20px;flex:none;}',
      '.ls-app-gross{display:block;width:100%;text-align:left;cursor:pointer;background:var(--card,#fff);',
      '  border:1px solid var(--line,#F6F9FA);border-radius:18px;padding:14px 16px;font:inherit;margin-bottom:22px;}',
      ...
      '  background:var(--card,#fff);border:1px solid var(--line,#F6F9FA);border-radius:14px;padding:9px 10px;}',
      ...
      '.ls-app-mod{background:var(--card,#fff);border:1px solid var(--line,#F6F9FA);border-radius:14px;',
      '  padding:10px 12px;}',
      ...
      '  background:#10627A;color:#fff;font-size:13px;font-weight:800;margin-right:8px;vertical-align:1px;}',
