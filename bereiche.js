...
{ id:'cafe', weg:'freizeit', gr:'einkaufen', t:'Café & Bäckerei',
  ...
  ws:['a2-cafe','a1-essen'], ho:['essen'], hilf:['a1-artikel','wortakzent','modalverben'],
...
{ id:'restaurant', bild:'sz-restaurant', weg:'freizeit', gr:'einkaufen', t:'Restaurant',
  ...
  ws:['essen','a2-essen'], ho:['essen'], hilf:['konjunktiv2','satzmelodie','modalverben'],
...
{ id:'supermarkt', weg:'freizeit', gr:'einkaufen', t:'Supermarkt & Einkaufen',
  ...
  ws:['einkaufen','a2-einkaufen','a1-einkaufen'], ho:['einkaufen'], hilf:['konjunktiv2','wechselpraepositionen','negation'],
...
{ id:'kleidung', bild:'sz-kleidung', weg:'freizeit', gr:'einkaufen', t:'Kleidung & Shopping',
  ...
  dlg:['umtausch'], ws:['a2-kleidung'], ho:['kleidung'], hilf:['adjektivdeklination','komparativ'],
...
{ id:'kochen', weg:'freizeit', gr:'einkaufen', t:'Kochen & Ernährung',
  ...
  dlg:['einkaufszettel','rezept-erklaeren'], ws:['essen'], ho:['essen'], hilf:['passiv-praesens','a1-artikel','imperativ'],
...
{ id:'apotheke', weg:'freizeit', gr:'gesundheit', t:'Apotheke',
  ...
  dlg:['apotheke-rezept'], ws:['gesundheit'], ho:['gesundheit'], hilf:['a1-artikel','ch','imperativ'],
...
{ id:'arzt', weg:'freizeit', gr:'gesundheit', t:'Arzt & Praxis',
  ...
  ws:['a2-arzt','c1-arzt','gesundheit'], ho:['gesundheit'], hilf:['perfekt-praeteritum','konnektoren','ch','reflexive-verben'],
  lek:'arzt-a2-b1.html' },
...
{ id:'amt', weg:'freizeit', gr:'papiere', t:'Amt & Behörde',
  ...
  ws:['a2-amt','amt-b1','c1-amt','integration'], ho:['amt'], hilf:['nominalisierung','genitiv','konnektoren','weil-dass-wenn'],
  lek:'amt-a2-b1.html' },
...
{ id:'bank', weg:'freizeit', gr:'papiere', t:'Bank & Geld',
  ...
  ws:['a2-bank','einkaufen'], ho:['bank'], hilf:['konjunktiv2','genitiv','modalverben'],
...
{ id:'post', bild:'sz-post', weg:'freizeit', gr:'papiere', t:'Post & Paket',
  ...
  dlg:['post'], ws:['a2-post'], ho:['post'], hilf:['wechselpraepositionen','praepositionen-dativ'],
...
{ id:'unterwegs', weg:'freizeit', gr:'unterwegs', t:'Bus, Bahn & unterwegs',
  ...
  ws:['a2-unterwegs','stadt'], ho:['stadt','reisen'], hilf:['wechselpraepositionen','vokale','praepositionen-dativ'],
...
{ id:'werkstatt', bild:'sz-werkstatt', weg:'freizeit', gr:'unterwegs', t:'Auto & Werkstatt',
  ...
  dlg:['fahrrad-reparatur','mietwagen-abholen'], ws:['a2-werkstatt'], ho:['werkstatt'], hilf:['passiv-praesens','perfekt-bilden'],
...
{ id:'reise', weg:'freizeit', gr:'unterwegs', t:'Reisen & Hotel',
  ...
  dlg:['hotel-einchecken'], ws:['reisen','strand'], ho:['reisen'], hilf:['temporale-nebensaetze','praepositionen-dativ'],
...
{ id:'wohnen', bild:'sz-wohnen', weg:'freizeit', gr:'unterwegs', t:'Wohnung & Nachbarn',
  ...
  ws:['wohnen','a2-wohnung','a1-wohnen'], ho:['wohnen'], hilf:['wechselpraepositionen','adjektivdeklination','r','possessivartikel'],
...
{ id:'freunde', bild:'sz-freunde', weg:'freizeit', gr:'menschen', t:'Freunde & Gefühle',
  ...
  ws:['gefuehle','persoenlichkeit'], ho:['gefuehle','persoenlichkeit'], hilf:['konjunktiv2','nebensaetze','satzmelodie','weil-dass-wenn'],
...
{ id:'familie', bild:'sz-familie', weg:'freizeit', gr:'menschen', t:'Familie & Kinder',
  ...
  ws:['c1-familie','a1-familie'], ho:['familie'], hilf:['konjunktiv2','temporale-nebensaetze','possessivartikel'],
...
{ id:'schule', bild:'sz-schule', weg:'freizeit', gr:'menschen', t:'Kita & Schule',
  ...
  ws:['a2-schule','bildung'], ho:['bildung'], hilf:['nebensaetze','indirekte-rede','weil-dass-wenn'],
...
{ id:'bewerbung', bild:'sz-bewerbung', weg:'beruf', gr:'ueberall', t:'Bewerbung & Vorstellung',
  ...
  ws:['bewerbung-b1','c1-bewerbung'], ho:['bewerbung'], hilf:['konjunktiv2','perfekt-praeteritum','satzmelodie','praeteritum-sein-haben','perfekt-bilden'],
...
{ id:'erste-tage', bild:'sz-erste-tage', weg:'beruf', gr:'ueberall', t:'Die ersten Tage',
  ...
  ws:['a2-arbeit','arbeit'], ho:['arbeit'], hilf:['nebensaetze','wortakzent','trennbare-verben'],
...
{ id:'medizin', bild:'sz-medizin',       weg:'beruf', gr:'feld', beruf:'medizin',       zeichen:'lupe',  dlg:['anamnese-kurz','befund-erklaeren'], ws:['c1-arzt'], ho:['medizin'], lek:'medizin-lektion.html' },
...
{ id:'reinigung', bild:'sz-reinigung',     weg:'beruf', gr:'feld', beruf:'reinigung',     zeichen:'haken', dlg:['reinigung-uebergabe','reinigung-beschwerde'], ws:['reinigung-neu'], ho:['reinigung'], lek:'reinigung-lektion.html' },
...
{ id:'ingenieur', bild:'sz-ingenieur',     weg:'beruf', gr:'feld', beruf:'ingenieur',     zeichen:'lupe',  dlg:['abnahme-begleiten','aenderung-begruenden'], ws:['ingenieur-neu'], ho:['ingenieur'], lek:'ingenieur-lektion.html' },
...
{ id:'ankommen', bild:'sz-ankommen', weg:'freizeit', gr:'ankommen', t:'Ankommen in Deutschland',
  ...
  ws:['ankommen-neu'], ho:['amt'], hilf:['a1-fragen','nebensaetze','weil-dass-wenn'],
...
{ id:'sprachkurs', bild:'sz-sprachkurs', weg:'freizeit', gr:'ankommen', t:'Im Deutschkurs',
  ...
  ws:['sprachkurs-neu'], ho:['bildung'], hilf:['a1-fragen','wortakzent','imperativ'],
...
{ id:'weiterbildung', bild:'sz-weiterbildung', weg:'freizeit', gr:'ankommen', t:'Weiterbildung & Anerkennung',
  ...
  ws:['weiterbildung-neu'], ho:['bildung','bewerbung'], hilf:['nebensaetze','konjunktiv2','perfekt-bilden'],
...
{ id:'telefonieren', bild:'sz-telefonieren', weg:'freizeit', gr:'digital', t:'Am Telefon',
  ...
  ws:['telefonieren-neu'], ho:['buero','amt'], hilf:['satzmelodie','konjunktiv2','imperativ'],
...
{ id:'medien', bild:'sz-medien', weg:'freizeit', gr:'digital', t:'Nachrichten, Werbung & Netz',
  ...
  ws:['medien-neu'], ho:['medien'], hilf:['konnektoren','indirekte-rede','komparativ'],
