...
(function () {
  ...
  function stil(){
    ...
    s.textContent = [
      ...
      '#v-bereiche .be-b.voll:hover{background:#B02B24;border-color:#B02B24;color:#fff;}',
      ...
      '  border-radius:50%;background:var(--petrol,#10627A);color:#fff;font-size:14px;font-weight:800;',
