...
(function () {
  ...
  css.textContent = [
    ...
    'border:2px solid var(--tinte,#14181B);background:var(--karte,#FFFFFF);cursor:pointer;padding:0;',
    ...
    '.hc-btn .kr{display:none;font-size:26px;line-height:58px;color:var(--tinte,#14181B)}',
    ...
    'background:var(--karte,#FFFFFF);border:2px solid var(--tinte,#14181B);border-radius:22px;',
    ...
    '.hc-kopf{background:linear-gradient(135deg,#F6F9FA,var(--karte,#FFFFFF));',
    'border-bottom:2px solid var(--tinte,#14181B);padding:12px 14px 10px;display:flex;gap:11px;align-items:flex-end}',
    ...
    'font-weight:800;color:var(--tinte,#14181B);line-height:1.2}',
    '.hc-kopf span{display:block;font-size:12px;color:var(--text-soft,#5A6B72);margin-top:1px}',
    '.hc-zu{background:none;border:0;color:var(--text-soft,#5A6B72);font-size:21px;cursor:pointer;',
    'line-height:1;padding:2px 4px;align-self:flex-start;border-radius:8px}',

    '.hc-lauf{flex:1;overflow-y:auto;padding:14px;background:var(--creme,#F6F9FA)}',
    ...
    '.hc-m.bot b{font-weight:800;color:var(--tuerkis-dunkel,#10627A)}',
    '.hc-bsp{margin:7px 0;padding:7px 11px;border-left:3px solid var(--tuerkis-dunkel,#10627A);',
    'background:var(--tuerkis-hauch,#E6F8FC);border-radius:0 10px 10px 0;font-size:14.5px}',
    '.hc-bsp b{color:var(--tinte,#14181B)!important;',
    ...
    'background:#fff;color:var(--tinte,#14181B)}',
    '.hc-fuss input{margin-bottom:7px}',
    '.hc-fuss textarea:focus,.hc-fuss input:focus{outline:none;border-color:var(--tuerkis-dunkel,#10627A);',
    'box-shadow:0 0 0 3px var(--tuerkis-hauch,#E6F8FC)}',
