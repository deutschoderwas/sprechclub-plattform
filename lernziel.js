...
'.lz-back{width:36px;height:36px;border-radius:11px;border:1px solid #F6F9FA;background:#fff;color:#6E6A63;display:flex;align-items:center;justify-content:center;cursor:pointer;flex:none;transition:.2s}',
'.lz-back:hover{color:#171717;border-color:#9A958C}',
'.lz-back[hidden]{display:none}',
'.lz-prog{flex:1;height:5px;border-radius:99px;background:#F6F9FA;overflow:hidden}',
...
'.lz-o{display:flex;align-items:center;gap:15px;width:100%;text-align:left;border:1.5px solid #F6F9FA;background:#fff;border-radius:18px;padding:13px 15px;cursor:pointer;font-family:inherit;transition:.18s;box-shadow:0 1px 2px rgba(23,23,23,.03)}',
...
'.lz-o .ck{width:24px;height:24px;border-radius:50%;border:1.5px solid #F6F9FA;flex:none;display:flex;align-items:center;justify-content:center;color:#fff}',
...
'.lz-n{border:1.5px solid #F6F9FA;background:#fff;border-radius:15px;padding:15px 8px;cursor:pointer;font-family:"Space Grotesk",Inter,sans-serif;font-size:19px;font-weight:700;letter-spacing:-.02em;color:#171717;transition:.18s}',
...
'.lz-c{border:1.5px solid #F6F9FA;background:#fff;border-radius:99px;padding:10px 17px;cursor:pointer;font-family:inherit;font-size:14.5px;font-weight:600;color:#6E6A63;transition:.18s}',
...
/* Dashboard-Karte */
'.lz-card{display:block;background:#fff;border:1px solid #F6F9FA;border-radius:20px;padding:18px 19px;text-decoration:none;color:#171717;margin-bottom:16px;box-shadow:0 1px 2px rgba(23,23,23,.04),0 12px 30px -24px rgba(23,23,23,.5);transition:.2s}',
