...
'.lz-prog i{display:block;height:100%;background:#12A594;border-radius:99px;transition:width .45s cubic-bezier(.16,1,.3,1)}',
...
'.lz-k{font-size:11.5px;font-weight:700;letter-spacing:.09em;text-transform:uppercase;color:#0E7C70;margin-bottom:9px}',
...
'.lz-o.on{border-color:#12A594;background:#EAF7F4;box-shadow:0 0 0 3px rgba(18,165,148,.12)}',
...
'.lz-o.on .ck{background:#12A594;border-color:#12A594}',
...
'.lz-n.on{border-color:#12A594;background:#EAF7F4;color:#0E7C70}',
...
'.lz-c.on{border-color:#12A594;background:#EAF7F4;color:#0E7C70}',
...
'.lz-date:focus{border-color:#12A594}',
...
'.lz-btn.p{background:#12A594;color:#fff;box-shadow:0 10px 26px -14px rgba(18,165,148,.95)}',
'.lz-btn.p:hover{background:#0E7C70}',
...
'.lz-link{display:inline-flex;align-items:center;gap:8px;background:#fff;border:1px dashed #CFEBE5;color:#0E7C70;border-radius:14px;padding:13px 16px;text-decoration:none;font-size:14.5px;font-weight:600;margin-bottom:24px;transition:.2s}',
'.lz-link:hover{border-style:solid;background:#EAF7F4}',
/* Abschluss */
'.lz-fin{background:linear-gradient(135deg,#0E7C70,#12A594);border-radius:24px;padding:26px 24px;color:#fff;margin-bottom:18px;box-shadow:0 18px 44px -22px rgba(18,165,148,1)}',
...
'.lz-card:hover{border-color:#CFEBE5;transform:translateY(-1px)}',
'.lz-card .ch{display:flex;align-items:center;gap:9px;margin-bottom:9px}',
'.lz-card .ch .kk{font-size:11px;font-weight:700;letter-spacing:.08em;text-transform:uppercase;color:#0E7C70}',
...
'.lz-card .tr i{display:block;height:100%;background:#12A594;border-radius:99px;transition:width .6s cubic-bezier(.16,1,.3,1)}',
'.lz-card .go{display:flex;align-items:center;gap:7px;font-size:14px;font-weight:600;color:#0E7C70}',
  ...
  return '<div class="lz-k">Dein Ziel</div>'
   ...
   +'<div class="lz-opts">'+ZIELE.map(function(z){
      return '<button class="lz-o'+(st.ziel===z.id?' on':'')+'" onclick="LZ.setZiel(\''+z.id+'\')">'
       +'<span class="im"><img src="'+bild(z.b)+'" alt="" onerror="this.parentNode.style.background=\'#EAF7F4\'"></span>'
