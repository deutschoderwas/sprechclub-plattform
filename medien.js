...
(function () {
  var STIL = [
    ...
    '#v-medien .md-kachel:nth-child(2n) .md-bild{background:var(--gold-soft,#F6F9FA)}',
    ...
    '#v-medien .md-stufe{margin-left:auto;background:var(--gold-soft,#F6F9FA);color:#7a5504;border-radius:999px;',
