...
(function () {
  var STIL = [
    ...
    '.lp-weiter{background:linear-gradient(135deg,var(--turq,#1B9BC0),#2795b3);color:#fff;border-radius:20px;padding:18px 20px;margin-bottom:18px}',
    ...
    '.lp-block.fertig .lp-bk .em{background:var(--turq,#1B9BC0);color:#fff}',
    ...
    '.lp-bal i{display:block;height:100%;background:var(--turq,#1B9BC0);border-radius:99px;transition:.3s}',
    ...
    '.lp-s.fertig:not(:last-child)::before{background:var(--turq,#1B9BC0)}',
    ...
    '.lp-s.fertig .lp-p{background:var(--turq,#1B9BC0);border-color:var(--turq,#1B9BC0);color:#fff}',
    '.lp-s.jetzt .lp-p{border-color:var(--gold,#EBA30B);background:var(--gold-soft,#F6F9FA);box-shadow:0 0 0 4px var(--gold-soft,#F6F9FA)}',
    '.lp-s .tx{flex:1;padding-top:2px}',
    '.lp-s b{display:block;font-size:15px}',
    '.lp-s small{color:var(--text-soft,#5A6B72);font-size:12.5px}',
    '.lp-pill{display:inline-block;background:var(--gold-soft,#F6F9FA);color:#7a5504;border-radius:999px;padding:2px 9px;font-size:11px;font-weight:700;margin-top:4px}',
