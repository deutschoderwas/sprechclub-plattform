...
(function(){
  ...
  var QUELLEN = { 'A1':'HOEREN_A1', 'A2':'HOEREN_A2', 'B1':'HOEREN_B1', 'B2':'HOEREN_B2' };
...
'  place-items:center; font-size:20px; background:#fff; border:1.5px solid #F6F9FA;',
...
'  background:#fff; border:1.5px solid #F6F9FA; border-radius:18px;',
...
'.ph-play[disabled]{ background:#E7ECEE; color:#8A97A0; box-shadow:none; cursor:default }',
...
'.ph-skript{ margin-top:16px; background:#fff; border:1.5px solid #F6F9FA;',
