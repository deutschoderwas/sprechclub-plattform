...
window.LEKTION = {
  ...
  uebungen: [
    ...
    { typ: 'mc', frage: 'Die Patientin fragt: „Kann da was passieren?" Welche Antwort ist richtig?', optionen: ['Selten kann es bluten, sehr selten entsteht ein Riss — dann müsste operiert werden.', 'Nein, dabei kann überhaupt nichts passieren, das ist völlig harmlos.', 'Theoretisch kann bei jedem Eingriff immer alles Mögliche passieren.'], richtig: 0, hinweis: 'Risiken werden benannt und eingeordnet. Verharmlosen und Dramatisieren sind beides Aufklärungsfehler.' },
    ...
    { typ: 'mc', frage: 'Welche Rückversicherung ist wirklich eine Rückversicherung?', optionen: ['Haben Sie das alles so weit verstanden, oder gibt es noch Fragen?', 'Alles klar so weit? Dann unterschreiben Sie hier bitte einmal unten.', 'Erzählen Sie mir bitte mit Ihren eigenen Worten, was morgen passiert.'], richtig: 2, hinweis: 'Auf „Haben Sie alles verstanden?" sagen fast alle Menschen ja. Erst das Nacherzählen zeigt, was angekommen ist.' },
