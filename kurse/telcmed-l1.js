...
window.LEKTION = {
  ...
  uebungen: [
    ...
    { typ: 'mc', frage: 'Welche Formulierung zeigt der Kommission, dass du aktiv zuhörst?', optionen: ['Habe ich Sie richtig verstanden, dass der Schwindel beim Umdrehen im Bett auftritt?', 'Aha. Und weiter?', 'Das schreibe ich mir auf.'], richtig: 0, hinweis: 'Paraphrasieren heißt: mit eigenen Worten wiederholen und rückfragen. Das sichert die Information und wirkt professionell.' },
