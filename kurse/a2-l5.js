...
window.LEKTION = {
  ...
  uebungen: [
    ...
    { typ: 'order', frage: 'Bau den Vergleich!', woerter: ['ist', 'Der', 'als', 'graue', 'nicht', 'der', 'blaue', 'teurer'], loesung: 'Der graue ist nicht teurer als der blaue', hinweis: 'Der Komparativ steht vor als, nicht danach. Und denk an das, was Tobias im Laden gesagt hat.' },
