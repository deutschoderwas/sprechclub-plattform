...
window.LEKTION = {
  ...
  uebungen: [
    ...
    { typ: 'mc', frage: 'Was gehört in eine Einladung, damit niemand nachfragen muss?', optionen: ['Datum, Uhrzeit, Dauer, Ort oder Link und Thema', 'nur Datum und Uhrzeit', 'nur das Thema'], richtig: 0, hinweis: 'Jede fehlende Angabe erzeugt eine Rückfrage — und die kostet mehr Zeit als das Eintippen.' },
