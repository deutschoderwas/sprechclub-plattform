...
window.LEKTION = {
  ...
  uebungen: [
    ...
    { typ: 'mc', frage: 'Der Fahrer drängt und du siehst einen Schaden. Was tust du zuerst?', optionen: ['Fotografieren und den Schaden auf dem Lieferschein vermerken lassen.', 'Unterschreiben und später anrufen.', 'Die komplette Lieferung verweigern.'], richtig: 0, hinweis: 'Ohne Vermerk auf dem Lieferschein ist ein Transportschaden später kaum durchzusetzen.' },
    ...
    { typ: 'bild', bild: 'th-wirtschaft', frage: 'Die Frist ist abgelaufen, der Lieferant meldet sich nicht. Wie fasst du nach?', optionen: ['Ich beziehe mich auf meine Mail vom 14.03. und bitte um Rückmeldung bis morgen, 12 Uhr.', 'Warum antworten Sie nicht???', 'Ich warte lieber noch eine Woche ab.'], richtig: 0, hinweis: 'Nachfassen heißt: alte Nachricht nennen, neue Frist setzen, Ton halten.' },
