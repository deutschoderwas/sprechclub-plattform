...
window.LEKTION = {
  ...
  uebungen: [
    { typ: 'mc', frage: 'Du kennst die Antwort auf eine Prüferfrage nicht. Was sagst du?', optionen: ['Das kann ich nicht sicher sagen. Ich würde zunächst eine Sonografie veranlassen, um … auszuschließen.', 'Ich weiß es nicht.', 'Nichts — lieber nachdenken, bis es einem einfällt.'], richtig: 0, hinweis: 'Ehrlich bleiben, aber weitersprechen. Jeder Satz, der ein Vorgehen begründet, bringt Punkte.' },
