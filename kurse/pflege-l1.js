...
window.LEKTION = {
  ...
  uebungen: [
    ...
    { typ: 'gapbank', frage: 'Setz die Passivform richtig ein.', text: 'Der Verband ___ heute Morgen ___. Die Patientin ___ anschließend mobilisiert.', bank: ['wurde', 'gewechselt', 'wurde', 'wechselte', 'hat', 'worden'], loesung: ['wurde', 'gewechselt', 'wurde'], hinweis: 'wurde + Partizip II' },
    ...
    { typ: 'mc', frage: 'Die Kollegin fragt: „Hat sie Schmerzen angegeben?" Beste Antwort:', optionen: ['Ja, sie hatte schon ein bisschen Schmerzen, aber nicht so schlimm.', 'Ich glaube schon, aber genau kann ich das jetzt nicht mehr sagen.', 'Ja, Schmerzstärke vier, um acht Uhr ein Schmerzmittel erhalten.'], richtig: 2, hinweis: 'Immer konkret: Stärke, Uhrzeit, Maßnahme.' },
