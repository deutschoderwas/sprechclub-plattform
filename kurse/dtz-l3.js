...
window.LEKTION = {
  ...
  uebungen: [
    ...
    { typ: 'mc', frage: 'Welcher Schluss passt in eine halbformelle Nachricht?', optionen: ['Das war jetzt alles von mir. Tschüss und bis demnächst mal', 'Ich freue mich über eine kurze Antwort. Mit freundlichen Grüßen', 'Antworten Sie mir bitte schnell zurück. Danke im Voraus schon mal'], richtig: 1, hinweis: 'Ein Schlusssatz plus Grußformel — beides gehört zur Rahmung und wird bewertet.' },
