...
window.LEKTION = {
  meta: { kurs: 'Deutsch für Mediziner', nr: 1, titel: 'Die Anamnese – das Erstgespräch', level: 'B2', bild: 'photo-1576091160550-2173dba999ef', dauer: 'ca. 20 Min' },
  intro: {
  ...
  dialog: {
    bild: 'photo-1576091160550-2173dba999ef',
