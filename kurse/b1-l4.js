...
window.LEKTION = {
  ...
  uebungen: [
    ...
    { typ: 'bild', bild: 'th-arzt', frage: 'Der Arzt fragt: „Wie geht es Ihnen sonst?" Welche Antwort bringt euch weiter?', optionen: ['Ganz gut, danke — nur das Wetter macht mir in letzter Zeit ziemlich zu schaffen.', 'Eigentlich wie immer, da gibt es wirklich nichts Besonderes zu berichten.', 'Eigentlich gut, aber ich schlafe seit drei Monaten schlecht, obwohl ich früh ins Bett gehe.', 'Das steht doch alles in meiner Akte, da müssten Sie eigentlich Bescheid wissen.'], richtig: 2, hinweis: 'Nenne Dauer und Widerspruch. Je konkreter deine Beschreibung, desto genauer die Diagnose.' },
