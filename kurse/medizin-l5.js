...
window.LEKTION = {
    ...
    blocks: [
      ...
      },
      {
        ...
        table: [
          ...
          ['Vorsichtig nach der Machbarkeit fragen', 'Können Sie mir sagen, ob die Untersuchung heute noch möglich ist?'],
  ...
  uebungen: [
    { typ: 'listen', audio: 'Zunächst Ultraschall, daraufhin Labor, im Anschluss deutliche klinische Verschlechterung.', frage: 'Hör zu: In welcher Reihenfolge ist das passiert?', optionen: ['Labor, dann Ultraschall, dann Verschlechterung', 'Ultraschall, dann Labor, dann Verschlechterung', 'Verschlechterung, dann Ultraschall, dann Labor'], richtig: 1 },
    ...
    { typ: 'mc', frage: 'Welche Angabe fehlt in dieser Anmeldung zwingend: Name, Alter, Aufnahmegrund, aktuelle Werte — und …?', optionen: ['Beruf und Familienstand', 'Name des aufnehmenden Kollegen', 'Nierenwerte und bekannte Kontrastmittelallergie'], richtig: 2, hinweis: 'Die Radiologie kann ohne Nierenwerte und Allergiestatus kein Kontrastmittel geben. Wer das nicht mitliefert, wird garantiert zurückgerufen — und verliert doppelt Zeit.' },
