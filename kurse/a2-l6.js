...
window.LEKTION = {
  ...
  uebungen: [
    ...
    { typ: 'type', frage: 'Erklär den Weg von der Haltestelle zu dir nach Hause. Nutze den Imperativ mit Sie.', muster: 'Gehen Sie geradeaus und nehmen Sie die zweite Straße rechts.', akzeptiert: ['(gehen|fahren|nehmen|biegen|steigen|laufen|folgen|überqueren|halten) sie .+', 'sie (gehen|fahren|nehmen|biegen|steigen|laufen|folgen) .+', '(geradeaus|rechts|links|die erste|die zweite|die dritte)'], hinweis: 'Sie-Imperativ: Verb im Infinitiv zuerst, dann Sie, dann der Rest.' }
  ],
  zusammenfassung: {
    kernsaetze: [
