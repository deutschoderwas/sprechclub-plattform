...
window.LEKTION = {
  ...
  uebungen: [
    ...
    { typ: 'mc', frage: 'Wie klingt „Wir haben ihm ein Entwässerungsmittel gegeben, danach ging die Schwellung zurück" im Nominalstil?', optionen: ['Wir gaben Furosemid und die Schwellung ging zurück', 'Nachdem Furosemid gegeben wurde, ging die Schwellung zurück', 'Unter Gabe von Furosemid Rückgang der Schwellung'], richtig: 2, hinweis: 'Im Nominalstil wird die Therapie mit „unter" angeschlossen und die Folge als Substantiv genannt. Beide anderen Varianten sind korrektes Deutsch, aber Erzählform statt Vorstellungsform.' },
    ...
    { typ: 'mc', frage: 'Was gehört NICHT in eine Kurzvorstellung von neunzig Sekunden?', optionen: ['Sättigung bei Aufnahme 88 Prozent unter Raumluft.', 'Der Patient wohnt allein und mag keinen Krankenhauskaffee.', 'Bekannte Herzschwäche und Diabetes Typ 2.'], richtig: 1, hinweis: 'In die Vorstellung gehört nur, was die Entscheidung beeinflusst. Soziale Angaben kommen erst dazu, wenn sie für Entlassung oder Versorgung relevant werden.' },
