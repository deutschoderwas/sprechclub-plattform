...
window.LEKTION = {
  ...
  uebungen: [
    ...
    { typ: 'listen', audio: 'Am ehesten dürfte eine Cholezystolithiasis mit beginnender Cholezystitis vorliegen.', frage: 'Hör zu: Wie sicher ist sich die Ärztin?', optionen: ['Sie ist sich völlig sicher und schließt andere Ursachen klar aus.', 'Sie hält es für sehr wahrscheinlich, legt sich aber nicht endgültig fest.', 'Sie hält es für unwahrscheinlich und denkt eher an etwas anderes.'], richtig: 1 },
