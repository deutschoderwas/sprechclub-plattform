...
window.LEKTION = {
  ...
  uebungen: [
    ...
    { typ: 'type', frage: 'Weise einen Einwand zurück, ohne ihn kleinzumachen — benutze „gleichwohl".', muster: 'Ihr Einwand ist berechtigt; gleichwohl halte ich an dem Vorschlag fest.', akzeptiert: ['gleichwohl', 'nichtsdestotrotz', 'nichtsdestoweniger', 'dessen ungeachtet', 'ungeachtet dessen'], hinweis: 'Achte auf die Wortstellung nach dem Adverb: Position eins ist „gleichwohl", dann kommt sofort das finite Verb und erst danach das Subjekt.' }
  ],
  zusammenfassung: {
    kernsaetze: [
