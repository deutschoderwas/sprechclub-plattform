...
window.LEKTION = {
  ...
  uebungen: [
    ...
    { typ: 'bild', bild: 'th-arzt', frage: 'Die Ärztin sagt: „Sauerstoff sechs Liter." Was antwortest du?', optionen: ['Ich wiederhole: sechs Liter Sauerstoff.', 'Ja, mache ich sofort, kein Problem.', 'Alles klar, wie viel war das noch mal?'], richtig: 0, hinweis: 'Anweisung zurückgeben heißt: laut wiederholen. Nur so merken beide, wenn etwas falsch angekommen ist.' },
