...
window.LEKTION = {
  ...
  uebungen: [
    ...
    { typ: 'mc', frage: 'Welcher Satz widerspricht, ohne den anderen vor den Kopf zu stoßen?', optionen: ['Das ist doch völliger Quatsch, das kann so nicht klappen.', 'Da haben Sie offenbar nicht richtig zugehört, glaube ich.', 'Ich sehe das anders, weil die Schulungen noch fehlen.'], richtig: 2, hinweis: 'Widerspruch braucht immer eine Begründung mit „weil".'},
