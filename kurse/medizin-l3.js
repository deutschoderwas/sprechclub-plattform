...
window.LEKTION = {
  ...
  uebungen: [
    ...
    { typ: 'mc', frage: 'Welche Formulierung nennt das Risiko korrekt, ohne zu erschrecken?', optionen: ['Da kann eigentlich nichts passieren, machen Sie sich keine Gedanken.', 'Gelegentlich, etwa bei einem von hundert — sollte es eintreten, würden wir sofort reagieren.', 'Es kann zu schweren Blutungen kommen, im schlimmsten Fall mit tödlichem Ausgang.'], richtig: 1, hinweis: 'Ehrliche Aufklärung besteht aus drei Teilen: Häufigkeit nennen, einordnen, Handlungsplan anhängen. Weder Verharmlosen noch die nackte Schreckensvariante erfüllen das.' },
    ...
    { typ: 'mc', frage: 'Welche Rückversicherungsfrage prüft das Verständnis wirklich?', optionen: ['Haben Sie das jetzt alles verstanden?', 'Ist noch irgendwas unklar geblieben?', 'Sagen Sie mir bitte in Ihren eigenen Worten, was morgen passiert.'], richtig: 2, hinweis: 'Nur das Zurückerzählen zeigt, was angekommen ist. Ja-Nein-Fragen beantworten fast alle Patienten reflexhaft mit Ja — aus Höflichkeit oder aus Scham.' },
