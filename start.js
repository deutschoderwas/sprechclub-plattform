...
(function(){
  ...
  + '.st{--tint:#1B9BC0;--tint2:#7ED8EA;--ink:#161616;--weich:#5B6470;'
  +     '--rand:#EAE6DE;--karte:#fff;--gold:#FFCE00;--warm:#FFF8E8;--mint:#EAFBF6;'
  +     '--schatten:0 1px 3px rgba(22,22,22,.04)}'
  ...
  + '.st-gruss h1{font-family:"Space Grotesk",sans-serif;font-size:30px;font-weight:700;'
  +   'letter-spacing:-.015em;color:var(--ink);margin:0;line-height:1.15}'
  ...
  +   'border:1px solid var(--rand);border-radius:20px;box-shadow:var(--schatten);overflow:hidden;min-height:252px}'
  + '@media(max-width:620px){.st-kurs{grid-template-columns:1fr}}'
  + '.st-kurs .bild{position:relative;background:linear-gradient(140deg,#7ED8EA,#EFFBF8);min-height:160px;overflow:hidden}'
  ...
  +   'background:linear-gradient(90deg,#161616 0 25%,#DD0000 25% 50%,#FFCE00 50% 75%,#7ED8EA 75% 100%)}'
  + '.st-kurs .stufe{position:absolute;left:14px;top:14px;z-index:2;background:#fff;color:#10627A;'
  +   'font-family:"Space Grotesk",sans-serif;font-weight:700;font-size:12.5px;letter-spacing:.06em;'
  +   'border-radius:999px;padding:6px 14px;border:1px solid rgba(45,212,191,.3);box-shadow:0 2px 6px rgba(0,0,0,.10)}'
  + '.st-kurs .txt{padding:22px 26px 22px;display:flex;flex-direction:column;min-width:0}'
  + '.st-kurs .eyebrow{display:inline-flex;align-items:center;gap:8px;color:#DD0000;font-weight:800;'
  +   'font-size:12px;letter-spacing:.12em;text-transform:uppercase}'
  + '.st-kurs .eyebrow::before{content:"";width:18px;height:3px;border-radius:3px;'
  +   'background:linear-gradient(90deg,#DD0000,#FFCE00,#7ED8EA)}'
  + '.st-kurs h2{font-family:"Space Grotesk",sans-serif;font-size:24px;font-weight:700;line-height:1.2;'
  +   'color:var(--ink);margin:9px 0 0;letter-spacing:-.015em}'
  ...
  + '.st-bar i{display:block;height:100%;border-radius:999px;background:linear-gradient(90deg,#7ED8EA,#2CC0AE);transition:width .5s}'
  ...
  +   'font-family:inherit;font-size:15px;font-weight:700;border-radius:12px;padding:13px 22px;'
  +   'text-decoration:none;transition:transform .12s,box-shadow .12s,background .15s}'
  + '.st-b1{background:#7ED8EA;color:#10627A;box-shadow:0 4px 0 #1B9BC0}'
  + '.st-b1:hover{background:#93DFEE;transform:translateY(-1px);box-shadow:0 5px 0 #1B9BC0}'
  + '.st-b1:active{transform:translateY(3px);box-shadow:0 1px 0 #1B9BC0}'
  + '.st-b2{background:#fff;color:var(--ink);border:1.5px solid var(--rand);box-shadow:0 3px 0 #E2D9C9}'
  + '.st-b2:hover{background:#FFFDF7;transform:translateY(-1px)}'
  + '.st-b2:active{transform:translateY(2px);box-shadow:0 1px 0 #E2D9C9}'
  ...
  +   'letter-spacing:.1em;text-transform:uppercase;color:#DD0000}'
  + '.st-live .marke i{width:7px;height:7px;border-radius:50%;background:#DD0000;animation:stPuls 1.6s infinite}'
  ...
  + '.st-z .v{font-family:"Space Grotesk",sans-serif;font-size:30px;font-weight:700;color:var(--ink);margin-top:4px;line-height:1}'
  + '.st-z .d{font-size:12px;color:var(--weich);margin-top:2px}'

  /* Abschnitts-Überschrift mit Flaggenstrich */
  + '.st-titel{margin:8px 0 -8px}'
  + '.st-titel .tag{display:inline-flex;align-items:center;gap:8px;color:#DD0000;font-weight:800;'
  +   'font-size:12.5px;letter-spacing:.12em;text-transform:uppercase}'
  + '.st-titel .tag::before{content:"";width:18px;height:3px;border-radius:3px;'
  +   'background:linear-gradient(90deg,#DD0000,#FFCE00,#7ED8EA)}'
  + '.st-titel h2{font-family:"Space Grotesk",sans-serif;font-size:23px;font-weight:700;color:var(--ink);margin:8px 0 0;letter-spacing:-.015em}'
  ...
  + '.st-kachel:hover{transform:translateY(-3px);box-shadow:0 12px 30px rgba(27,155,192,.16);border-color:#BEE9F3}'
  + '.st-kachel .bd{position:relative;aspect-ratio:16/9;background:linear-gradient(140deg,#7ED8EA,#EFFBF8);overflow:hidden}'
  ...
  + '.st-kachel .bd.portraet{background:linear-gradient(150deg,#EAFBF6,#FFF6D6)}'
  ...
  +   'background:#EAFBF6;display:flex;align-items:center;justify-content:center;font-size:19px;'
  ...
  /* Community */
  + '.st-chat{display:flex;align-items:center;gap:18px;border-radius:22px;padding:22px 24px;cursor:pointer;'
  +   'background:linear-gradient(135deg,#7ED8EA 0%,#9FE3F0 55%,#CFF9F0 100%);color:#0B4E5F;'
  +   'border:1px solid rgba(27,155,192,.25);box-shadow:0 6px 0 rgba(27,155,192,.35);'
  +   'transition:transform .14s,box-shadow .14s}'
  + '.st-chat:hover{transform:translateY(-2px);box-shadow:0 8px 0 rgba(27,155,192,.35)}'
  + '.st-chat:active{transform:translateY(3px);box-shadow:0 2px 0 rgba(27,155,192,.35)}'
  + '.st-chat .ic{flex:none;width:56px;height:56px;border-radius:16px;background:rgba(255,255,255,.7);'
  +   'display:flex;align-items:center;justify-content:center;font-size:27px}'
  + '.st-chat .tx{flex:1;min-width:0}'
  + '.st-chat .eb{display:flex;align-items:center;gap:9px;font-size:11.5px;font-weight:800;letter-spacing:.1em;text-transform:uppercase;color:#0B4E5F}'
  + '.st-chat .eb .an{display:inline-flex;align-items:center;gap:5px;background:rgba(255,255,255,.72);border-radius:999px;'
  +   'padding:3px 10px;letter-spacing:0;text-transform:none;font-weight:700;font-size:11px}'
  + '.st-chat .eb .an i{width:6px;height:6px;border-radius:50%;background:#0FA37F;animation:stPuls 2s infinite}'
  + '.st-chat h3{font-family:"Space Grotesk",sans-serif;font-size:19px;font-weight:700;margin:8px 0 4px;color:#0B3F4E;line-height:1.25}'
  + '.st-chat p{font-size:14px;margin:0;line-height:1.5;max-width:620px;color:#14606F}'
  + '.st-chat .st-b3{background:#fff;color:#10627A;border:0;box-shadow:0 3px 0 rgba(27,155,192,.5)}'
