...
(function () {
  ...
  function stil(){
    ...
    s.textContent=[
'#v-lernen{--lb:#1F5FD1;--lb2:#12408F;--lr:#D42A21;--lg:#FFCE00;--lt:#12181F;--lm:#5E6A78;--lc:#fff;--ll:#E7EBF0;max-width:1180px;margin:0 auto;padding-bottom:70px}',
...
/* ---------- Gesprächsfenster ---------- */
'.dg-ov{--lb:#1F5FD1;--lb2:#12408F;--lr:#D42A21;--lg:#FFCE00;--lt:#12181F;--lm:#5E6A78;--lc:#fff;--ll:#E7EBF0;position:fixed;inset:0;z-index:9000;background:#F4F6F9;display:none;flex-direction:column}',
...
'.dg-korr{margin:6px 0 0;background:#FFF4F4;border:1px solid #F6D5D5;border-left:3px solid #D42A21;border-radius:11px;padding:9px 12px;font-size:13.5px;color:#7A1414;max-width:min(78%,520px);margin-left:auto}',
...
'.dg-rund.mic.laeuft{background:#D42A21;color:#fff;animation:dgpuls 1.1s infinite}',
