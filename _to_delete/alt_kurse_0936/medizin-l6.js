...
window.LEKTION = {
    ...
    blocks: [
      {
        ...
        table: [
          ...
          ['ja', 'gemeinsames Wissen, schafft Nähe', 'Sie kennen das ja von Ihrer Frau.'],
  ...
  uebungen: [
    ...
    { typ: 'mc', frage: 'Du hast die Diagnose gesagt. Der Patient schweigt. Was tust du?', optionen: ['Du schweigst mit und hältst die Pause aus.', 'Du erklärst sofort die Behandlungsmöglichkeiten.', 'Du sagst: Das wird schon wieder, da kommen viele durch.'], richtig: 0, hinweis: 'Nach der Nachricht kann niemand mehr Informationen aufnehmen. Die Pause gehört dem Patienten — wer sie füllt, füllt sie für sich selbst.' },
    ...
    { typ: 'gapbank', frage: 'Setz die passenden Modalpartikeln ein.', text: 'Was beschäftigt Sie ___ am meisten? Setzen Sie sich erst einmal ___ hin. Und fragen Sie ___ nach, wenn etwas unklar bleibt.', bank: ['denn', 'ruhig', 'doch', 'eben', 'wohl'], loesung: ['denn', 'ruhig', 'doch'], hinweis: '„denn" weicht die Frage auf, „ruhig" erlaubt etwas, „doch" ist der warme Anstoß. „eben" und „wohl" gehören zu Aussagen über Tatsachen, nicht zu Aufforderungen.' },
    ...
    { typ: 'bild', bild: 'th-arzt', frage: 'Der Patient fragt: „Wie lange habe ich noch?" Was antwortest du?', optionen: ['Diese Frage kann ich Ihnen heute ehrlich nicht beantworten. Was ich sagen kann, ist …', 'Statistisch liegt die mittlere Überlebenszeit bei etwa vierzehn Monaten.', 'Das sollten Sie besser mit Ihrem Hausarzt besprechen.', 'Darüber würde ich mir an Ihrer Stelle jetzt keine Gedanken machen.'], richtig: 0, hinweis: 'Ehrlich bleiben, ohne die Tür zuzuschlagen: sagen, was du nicht weißt, und sofort anschließen, was du weißt. Zahlen ohne Kontext, Weiterverweisen und Abwiegeln lassen den Patienten allein.' },
