...
window.LEKTION = {
  ...
  dialog: {
    ...
    lines: [
      ...
      { sp: 'Fatima', txt: 'Bewusstlose Person, achtundsiebzig Jahre, Kreislauf instabil. Haus B, Station 2, Zimmer 22.' },
    ...
    blocks: [
      {
        ...
        table: [
          ...
          ['Wärst du so nett und bleibst hier?', 'Du bleibst hier!', 'Präsens als Anweisung'],
  ...
  uebungen: [
    ...
    { typ: 'mc', frage: 'Du rufst die Leitstelle. Was gehört als Erstes in die Meldung?', optionen: ['Was passiert ist und wo genau du bist', 'Der Name des Bewohners', 'Die Vorerkrankungen des Bewohners'], richtig: 0, hinweis: 'Zuerst Ereignis und Ort — damit das Fahrzeug losfahren kann. Alles andere fragt die Leitstelle selbst ab.' },
    ...
    { typ: 'type', frage: 'Setz den Notruf ab: bewusstlose Frau, 84 Jahre, Atmung vorhanden, Seniorenheim Lindenhof, Haus A, Zimmer 5.', muster: 'Bewusstlose Person, weiblich, vierundachtzig Jahre, Atmung vorhanden. Seniorenheim Lindenhof, Haus A, Zimmer 5.', akzeptiert: ['bewusstlos', 'atmung', 'haus a', 'zimmer 5', 'vierundachtzig'], hinweis: 'Reihenfolge: Was ist passiert — wer ist betroffen — wie ist der Zustand — wo genau seid ihr.' },
  ...
  zusammenfassung: {
    kernsaetze: [
      ...
      'Bewusstlose Person, achtundsiebzig Jahre, Kreislauf instabil, Haus B, Zimmer 22.',
  ...
  sprechen: {
    ...
    tipps: ['Olena, komm sofort in die 14 — und bring den Notfallkoffer mit!', 'Bewusstlose Person, weiblich, vierundachtzig Jahre, Atmung vorhanden.', 'Aufgefunden um …, letzter Kontakt um …', 'Ich wiederhole: … — Soll ich … oder …?']
  }
};
