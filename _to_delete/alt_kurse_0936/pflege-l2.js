...
window.LEKTION = {
  ...
  uebungen: [
    ...
    { typ: 'gapbank', frage: 'Setz die richtigen Imperativformen ein.', text: '___ Sie sich bitte ganz langsam auf. ___ Sie sich am Griff fest. Und ___ Sie ganz vorsichtig.', bank: ['Setzen', 'Halten', 'seien', 'Seien', 'Stehen'], loesung: ['Setzen', 'Halten', 'seien'], hinweis: 'Bei „sein" heißt der Imperativ <b>seien Sie</b> — das ist die einzige unregelmäßige Form.' },
