...
window.LEKTION = {
    ...
    blocks: [
      {
        ...
        note: 'Zwei Bauteile reichen: <b>Substantiv auf -ung oder -e</b> (Lagerung, Ablehnung, Wechsel) plus <b>Uhrzeit</b>. Wenn du doch einen ganzen Satz brauchst, nimm Passiv — <b>wurde + Partizip II</b>.'
      },
      {
  ...
  uebungen: [
    ...
    { typ: 'type', frage: 'Dokumentiere im Nominalstil: Du hast um 9 Uhr das Kompressionsverband-Anlegen am rechten Bein durchgeführt.', muster: 'Anlage des Kompressionsverbandes am rechten Bein um 09:00 Uhr.', akzeptiert: ['anlage', 'kompressionsverband', 'um 09', 'um 9'], hinweis: 'Substantiv zuerst, dann Ort am Körper, dann Uhrzeit. Kein „ich".' }
  ],
  zusammenfassung: {
    kernsaetze: [
