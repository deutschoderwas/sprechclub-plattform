...
'    radial-gradient(900px 520px at 92% 4%, #F6F9FA 0%, transparent 58%),',
'    radial-gradient(760px 520px at 50% 108%, #FBE3E3 0%, transparent 60%), #F6F9FA;',
...
'  background:rgba(255,252,245,.93); backdrop-filter:blur(10px); border-bottom:1.5px solid #F6F9FA }',
'.pl-zu{ flex:none; width:38px; height:38px; border-radius:12px; border:1.5px solid #F6F9FA;',
...
'.pl-pk{ width:18px; height:6px; border-radius:999px; background:#E7ECEE }',
'.pl-pk.dran{ background:#8A97A0 }',
'.pl-pk.gut{ background:#16A34A }',
'.pl-pk.schlecht{ background:#D83636 }',
'.pl-pk.fertig{ background:#1B9BC0 }',
...
'  background:linear-gradient(100deg,#F6F9FA,#FFE9A8); border:1.5px solid #F0DFB0;',
...
'.pl-karte{ position:relative; text-align:left; background:#fff; border:1.5px solid #F6F9FA;',
...
'.pl-karte-bar{ grid-column:1/-1; height:7px; border-radius:999px; background:#F6F9FA;',
'  overflow:hidden; margin-top:6px }',
'.pl-karte-bar i{ display:block; height:100%; background:var(--pa,#1B9BC0); border-radius:999px }',
'.pl-karte-ziel{ grid-column:1/-1; font-size:12.5px; color:#5B6A70; line-height:1.5; margin-top:4px }',

'.pl-f-turq  { --pa:#1B9BC0; --pw:#E4F7FA; --pi:#0F5468 }',
'.pl-f-gold  { --pa:#E39A00; --pw:#F6F9FA; --pi:#8A5C00 }',
...
'.pl-teil{ background:#fff; border:1.5px solid #F6F9FA; border-radius:20px; padding:20px;',
...
'.pl-tipp{ background:#F6F9FA; border:1.5px dashed #F0DFB0; border-radius:14px;',
...
'.pl-r{ flex:1; min-width:84px; background:#FFFCF5; border:1.5px solid #F6F9FA;',
...
'.pl-symbol{ background:#fff; border:1.5px solid #F6F9FA; border-radius:20px;',
...
'.pl-text{ background:#fff; border:1.5px solid #F6F9FA; border-radius:18px; overflow:hidden;',
'  box-shadow:0 8px 22px -16px rgba(40,53,59,.5) }',
'.pl-text-kopf{ display:flex; align-items:center; gap:10px; padding:11px 14px;',
'  background:#FFFCF5; border-bottom:1.5px solid #F6F9FA }',
...
'  overflow:hidden; background:#F6F9FA; border:1.5px solid #F6F9FA; display:grid;',
'  place-items:center }',
...
'.pl-s-aushang .pl-text-kopf{ background:#F6F9FA; position:relative }',
...
/* --- A2: langer Text --- */
'.pl-lang{ background:#fff; border:1.5px solid #F6F9FA; border-radius:18px; overflow:hidden;',
...
'  padding:11px 16px; border-top:1px solid #F6F9FA; align-items:baseline }',
...
'.pl-x{ width:100%; background:#fff; border:2px dashed #E7ECEE; border-radius:14px;',
'  padding:13px 16px; font-size:15px; font-weight:700; color:#5B6A70; cursor:pointer;',
'  display:flex; align-items:center; gap:11px }',
'.pl-x b{ width:26px; height:26px; border-radius:9px; background:#F6F9FA; color:#5B6A70;',
...
'.pl-x.gut b{ background:#12883E; color:#fff }',
'.pl-x.schlecht{ border-style:solid; border-color:#D83636; background:#FDECEC; color:#B02B24 }',
'.pl-x.blass{ opacity:.45 }',

'.pl-sit{ background:#fff; border:1.5px solid #F6F9FA; border-left:5px solid #E39A00;',
...
'.pl-anz{ position:relative; text-align:left; background:#fff; border:2px solid #F6F9FA;',
'  border-radius:18px; padding:18px 18px 16px; cursor:pointer;',
'  transition:transform .14s, border-color .14s, box-shadow .14s }',
'.pl-anz:not([disabled]):hover{ transform:translateY(-3px); border-color:#1B9BC0;',
...
'  display:grid; place-items:center; background:#F6F9FA; color:#8A5C00;',
...
'.pl-anz.gut .pl-anz-b{ background:#12883E; color:#fff }',
...
'  border:1.5px solid #F6F9FA; border-radius:16px; padding:16px 18px; margin-bottom:14px }',
...
'  border:2px solid #F6F9FA; border-radius:16px; padding:17px 14px; cursor:pointer;',
...
'  background:#F6F9FA; font-size:14px }',
...
'.pl-rf-b.gut span{ background:#12883E; color:#fff }',
...
'  border:2px solid #F6F9FA; border-radius:16px; padding:15px 17px; cursor:pointer;',
...
'  place-items:center; background:#F6F9FA; font-family:"Space Grotesk",sans-serif;',
'  font-weight:800; font-size:14px; color:#5B6A70 }',
'.pl-opt.gut{ border-color:#16A34A; background:#E8F8EE }',
'.pl-opt.gut .pl-opt-b{ background:#12883E; color:#fff }',
...
'.pl-zl{ display:block; width:100%; text-align:left; background:#fff; border:2px solid #F6F9FA;',
...
'.pl-zl.voll{ border-color:#1B9BC0; background:#F4FBFC }',
...
'  border:1.5px dashed #E7ECEE; border-radius:14px; padding:12px 14px; cursor:pointer;',
...
/* luecke */
'.pl-lu-text{ background:#fff; border:1.5px solid #F6F9FA; border-radius:16px;',
'  padding:18px 20px; font-size:17px; line-height:2.1; margin:0 0 14px }',
'.pl-lu{ display:inline-block; min-width:86px; background:#F6F9FA; border:2px dashed #E0C97A;',
...
'.pl-lu.voll{ border-style:solid; border-color:#1B9BC0; background:#E4F7FA; color:#0F5468 }',
...
'.pl-bw{ background:#fff; border:2px solid #F6F9FA; border-radius:12px; padding:10px 16px;',
...
'.pl-fb.schlecht{ background:#F6F9FA; border-color:#F0DFB0 }',
...
'  background:conic-gradient(var(--rf,#1B9BC0) calc(var(--p)*1%), #E7ECEE 0) }',
...
'.pl-b1{ background:#fff; border:1.5px solid #F6F9FA; border-radius:14px; padding:12px 20px;',
'  font-weight:800; font-size:14.5px; cursor:pointer }',
'.pl-b1:hover{ background:#FFFCF5; border-color:#E7ECEE }',
