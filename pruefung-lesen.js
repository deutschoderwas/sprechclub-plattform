...
(function(){
  ...
  function malen(){
    ...
    if(art==='wahl'){
      ...
      h += '<div class="pl-opts">' + a.opt.map(function(o,k){
        ...
        return '<button class="pl-opt'+kl+'" '+(L.offen[L.i]!=null?'disabled':'onclick="lesenWahl('+k+')"')+'>'
  ...
  window.lesenRunde = function(teilNr, rundeId){
    ...
    if(!r) return;
    oeffnen();
    var folge = r.aufgaben.map(function(a){ return { a:a, art:t.art, texte:r.texte||null }; });
  ...
  window.lesenLauf = function(id){
    ...
    Lf.teile.forEach(function(t){
      t.aufgaben.forEach(function(a){ folge.push({ a:a, art:t.art, texte:t.texte||null, teilNr:t.nr }); });
    });
