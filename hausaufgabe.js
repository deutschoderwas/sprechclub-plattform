...
(function () {
  ...
  css.textContent = [
    ...
    '.ha-box{background:var(--karte,#FFFFFF);border:2px solid var(--tinte,#14181B);border-radius:22px;',
    'max-width:520px;width:100%;box-shadow:0 24px 60px -18px rgba(0,0,0,.5);overflow:hidden}',
    '.ha-kopf{padding:18px 22px 14px;background:linear-gradient(135deg,#F6F9FA,var(--karte,#FFFFFF));',
    'border-bottom:1.5px solid var(--linie,#E7ECEE);display:flex;gap:12px;align-items:flex-end}',
    ...
    '.ha-kopf p{margin:2px 0 0;font-size:13px;color:var(--text-soft,#5A6B72)}',
    '.ha-kopf .zu{background:none;border:none;font-size:22px;line-height:1;color:var(--text-soft,#5A6B72);',
    'cursor:pointer;padding:2px 6px;border-radius:8px;align-self:flex-start}',
    '.ha-leib{padding:16px 22px 20px}',
    '.ha-leib textarea{width:100%;min-height:130px;border:2px solid var(--linie,#E7ECEE);border-radius:14px;',
    ...
    '.ha-leib textarea:focus{outline:none;border-color:var(--tuerkis-dunkel,#10627A);',
    ...
    'border:1.5px dashed var(--linie,#E7ECEE);border-radius:14px;background:var(--creme,#F6F9FA);',
    'font-size:13.5px;color:var(--text-soft,#5A6B72);cursor:pointer}',
