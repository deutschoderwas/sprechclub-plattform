...
const echt = /^(zuerst|dauer\w*|steuer\w*|feuer\w*|abenteuer\w*|museum|poesie|\w*duell\w*|aktuell\w*|individuell\w*|manuell\w*|virtuell\w*|ritual\w*|jubel\w*|neuer\w*|teuer\w*|treue\w*|scheue\w*|\w*bauen|\w*baue|genue?g?\w*|\w*schauen|\w*schaue|\w*graue\w*|\w*blaue\w*|\w*neue\w*|\w*freue\w*|\w*reue\w*)$/i;
