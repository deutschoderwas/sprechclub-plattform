...
{id:'einkaufen',        t:'Einkaufen, Geld & Verträge',    art:'thema', b:'alltag', lvl:'A1–C1', ws:['einkaufen','c1-vertrag'],        ho:['einkaufen'],        dlg:['einkaufen','vertrag'], lek:'wortschatz-einkaufen-b1.html',        hilf:['konjunktiv2','genitiv','s-z-ss']},
{id:'wohnen',           t:'Wohnen & Nachbarn',             art:'thema', b:'alltag', lvl:'A2–C1', ws:['wohnen'],           ho:['wohnen'],           dlg:['wohnen'],              lek:'wortschatz-wohnen-b1.html',           hilf:['wechselpraepositionen','adjektivdeklination','r']},
{id:'gesundheit',       t:'Gesundheit, Arzt & Notfall',    art:'thema', b:'alltag', lvl:'A1–C1', ws:['gesundheit','zahnarzt','c1-arzt'], ho:['gesundheit'],  dlg:['gesundheit','notfall'],lek:'wortschatz-gesundheit-b1.html',       hilf:['perfekt-praeteritum','konnektoren','ch']},
{id:'amt',              t:'Ämter, Behörden & Ankommen',    art:'thema', b:'alltag', lvl:'A2–C1', ws:['integration','c1-amt'],      ho:[],                   dlg:['amt'],                 lek:null,                                  hilf:['nominalisierung','genitiv','konnektoren']},
{id:'reisen',           t:'Reisen, Bahn & Flughafen',      art:'thema', b:'alltag', lvl:'A1–C1', ws:['reisen'],           ho:['reisen'],           dlg:['unterwegs'],           lek:'wortschatz-reisen-b1.html',           hilf:['temporale-nebensaetze','wechselpraepositionen','r']},
...
{id:'familie',          t:'Familie, Kinder & Schule',      art:'thema', b:'alltag', lvl:'A2–C1', ws:[],                   ho:[],                   dlg:['familie','bildung'],   lek:null,                                  hilf:['temporale-nebensaetze','konnektoren','wortakzent']},
...
{id:'buero',            t:'Büro & Kolleginnen',            art:'thema', b:'beruf',  lvl:'A2–C1', ws:['arbeit','c1-buero'],           ho:['arbeit'],           dlg:['buero','team'],        lek:'wortschatz-arbeit-b1.html',           hilf:['indirekte-rede','konjunktiv2','wortakzent']},
{id:'bewerbung',        t:'Bewerbung & Vorstellung',       art:'thema', b:'beruf',  lvl:'B1–C1', ws:[],                   ho:[],                   dlg:['bewerbung'],           lek:null,                                  hilf:['konjunktiv2','perfekt-praeteritum','satzmelodie']},
{id:'kunden',           t:'Kunden & Telefon',              art:'thema', b:'beruf',  lvl:'B1–C1', ws:[],                   ho:[],                   dlg:['kunden'],              lek:null,                                  hilf:['konjunktiv2','passiv-praesens','satzmelodie']},
{id:'pflege',           t:'Pflege & Klinik',               art:'thema', b:'beruf',  lvl:'A2–C1', ws:[],                   ho:[],                   dlg:['pflege'],              lek:null,                                  hilf:['passiv-praesens','nebensaetze','ch']},
