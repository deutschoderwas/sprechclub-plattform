...
{id:'einkaufen',        t:'Einkaufen, Geld & Verträge',    art:'thema', b:'alltag', lvl:'A1–C1', ws:['einkaufen'],        ho:['einkaufen'],        dlg:['einkaufen','vertrag'], lek:'wortschatz-einkaufen-b1.html',        hilf:['konjunktiv2','genitiv','s-z-ss']},
...
{id:'gesundheit',       t:'Gesundheit, Arzt & Notfall',    art:'thema', b:'alltag', lvl:'A1–C1', ws:['gesundheit','zahnarzt'], ho:['gesundheit'],  dlg:['gesundheit','notfall'],lek:'wortschatz-gesundheit-b1.html',       hilf:['perfekt-praeteritum','konnektoren','ch']},
{id:'amt',              t:'Ämter, Behörden & Ankommen',    art:'thema', b:'alltag', lvl:'A2–C1', ws:['integration'],      ho:[],                   dlg:['amt'],                 lek:null,                                  hilf:['nominalisierung','genitiv','konnektoren']},
...
{id:'buero',            t:'Büro & Kolleginnen',            art:'thema', b:'beruf',  lvl:'A2–C1', ws:['arbeit'],           ho:['arbeit'],           dlg:['buero','team'],        lek:'wortschatz-arbeit-b1.html',           hilf:['indirekte-rede','konjunktiv2','wortakzent']},
