...
{id:'essen',            t:'Essen & Restaurant',            art:'thema', b:'alltag', lvl:'A1–B1', ws:['essen','a2-essen','a2-cafe'] ,            ho:['essen'],            dlg:['essen'],               lek:'wortschatz-essen-b1.html',            hilf:['konjunktiv2','umlaute','s-z-ss']},
{id:'einkaufen',        t:'Einkaufen, Geld & Verträge',    art:'thema', b:'alltag', lvl:'A1–C1', ws:['einkaufen','c1-vertrag','a2-einkaufen','a2-bank','a2-handy','a2-kleidung'] ,        ho:['einkaufen'],        dlg:['einkaufen','vertrag'], lek:'wortschatz-einkaufen-b1.html',        hilf:['konjunktiv2','genitiv','s-z-ss']},
...
{id:'reisen',           t:'Reisen, Bahn & Flughafen',      art:'thema', b:'alltag', lvl:'A1–C1', ws:['reisen','a2-unterwegs','a2-werkstatt'] ,           ho:['reisen'],           dlg:['unterwegs'],           lek:'wortschatz-reisen-b1.html',           hilf:['temporale-nebensaetze','wechselpraepositionen','r']},
{id:'stadt',            t:'Stadt & Verkehr',               art:'thema', b:'alltag', lvl:'A2–B1', ws:['stadt','a2-post','a2-friseur'],            ho:['stadt'],            dlg:[],                      lek:'wortschatz-stadt-b1.html',            hilf:['wechselpraepositionen','vokale']},
...
{id:'bildung',          t:'Lernen & Bildung',              art:'thema', b:'alltag', lvl:'A2–B2', ws:['bildung','a2-schule'],          ho:['bildung'],          dlg:[],                      lek:'wortschatz-bildung-b1.html',          hilf:['nebensaetze','perfekt-praeteritum']},
