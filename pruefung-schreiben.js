...
(function(){
  ...
  var QUELLEN = { 'A1':'SCHREIBEN_A1', 'A2':'SCHREIBEN_A2', 'B1':'SCHREIBEN_B1', 'B2':'SCHREIBEN_B2' };
...
'.pw-sit{ background:#fff; border:1.5px solid #F6F9FA; border-left:5px solid #1B9BC0;',
...
'.pw-punkte{ background:#fff; border:1.5px solid #F6F9FA; border-radius:16px;',
...
'.pw-fz-i:focus{ border-color:#1B9BC0 !important; background:#fff !important;',
...
'.pw-pk{ display:block; position:relative; background:#F6F9FA; border-radius:3px;',
...
'  color:#F6F9FA; font-style:normal; font-size:12px; font-weight:800;',
...
'.pw-tel-av{ width:34px; height:34px; border-radius:50%; background:#1B9BC0;',
...
'.pw-schreib{ background:#fff; border:1.5px solid #F6F9FA; border-radius:18px;',
...
'  padding-top:10px; border-top:1px solid #F6F9FA }',
...
'.pw-hilfen{ background:#F6F9FA; border:1.5px dashed #F0DFB0; border-radius:14px;',
...
'.pw-deins{ background:#fff; border:1.5px solid #F6F9FA; border-radius:16px;',
'  padding:15px 18px; margin-bottom:14px }',
...
'.pw-erg.knapp{ background:#F6F9FA; border-color:#F0DFB0 }',
...
'.pw-erg-r.voll i{ background:#12883E; color:#fff }',
...
'  border:2px dashed #E7ECEE; border-radius:16px; padding:12px; align-content:start }',
...
'  border:1.5px solid #B9E6F0; border-left:5px solid #1B9BC0;',
'  border-radius:11px; padding:10px 14px; font-size:15px; font-weight:600; color:#123C46 }',
'.pw-ord-z>i{ flex:none; width:22px; height:22px; border-radius:50%; background:#167E9C;',
...
'  border:2px solid #F6F9FA; border-radius:12px; padding:11px 15px; cursor:pointer;',
...
/* --- Selbstcheck --- */
'.pw-selbst{ background:#fff; border:2px solid #F6F9FA; border-radius:18px;',
...
'  background:#F6F9FA; border-radius:14px; padding:9px 15px; line-height:1; color:#28353B }',
...
'.pw-sr{ border-top:1px solid #F6F9FA; padding:11px 0 }',
...
'.pw-sfazit{ border-top:1px solid #F6F9FA; margin-top:4px; padding-top:11px;',
...
'  border:1.5px solid #E7ECEE; border-radius:11px; padding:7px 13px;',
'  cursor:pointer; transition:.14s }',
'.pw-sb i{ font-style:normal; font-weight:800; font-size:12px; width:19px; height:19px;',
'  border-radius:50%; display:grid; place-items:center; background:#F6F9FA; color:#8A97A0 }',
'.pw-sb:hover{ border-color:#28353B; transform:translateY(-1px) }',
'.pw-sb.w3.an{ background:#E8F8EE; border-color:#16A34A; color:#14532D }',
'.pw-sb.w3.an i{ background:#12883E; color:#fff }',
'.pw-sb.w15.an{ background:#F6F9FA; border-color:#E0B400; color:#5A3E00 }',
...
'.pw-amanda-b:disabled{ background:#4D5A5F; color:#C7D3D8; box-shadow:none;',
'  cursor:default; transform:none }',
'.pw-warten{ display:flex; align-items:center; gap:15px; background:#fff;',
'  border:1.5px solid #F6F9FA; border-radius:18px; padding:17px 19px; margin-bottom:12px }',
'.pw-warten-p{ flex:none; width:26px; height:26px; border-radius:50%;',
'  border:3px solid #E4F7FA; border-top-color:#1B9BC0; animation:pwDreh .8s linear infinite }',
...
'.pl-weiter.aus{ background:#E7ECEE; color:#8A97A0; box-shadow:none; cursor:default }',
